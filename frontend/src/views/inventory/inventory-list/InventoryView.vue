                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- <feather-icon
                           ...
                           /> -->
                           <b-card-header class="pl-0 pr-0 editDropdown">
                                 <b-dropdown
                                    variant="link"
                                    no-caret
            ...
            <div class="card border-default customerInfo"  @mouseover="customereditactiveicon = false"
               ...
               <div class="card-header d-flex justify-content-between align-items-center pt-75 pb-25">
                  ...
                  <span class="badge badge-light-primary">
                     ...
                     <b-card-header class="pl-0 pr-0 custEditDropdown">
                        <b-dropdown
                           variant="link"
                           no-caret
                           class="chart-dropdown documentsDropdown"
      ...
      <div class="col-md-8 col-lg-8 col-xl-8 col-12 ">
         ...
         <div class="col-md-4 col-lg-4 col-xl-4 col-12 ">
            <template>
               <b-card
                  no-body
                  class="card-browser-states documentCard"
                  >
                  <b-card-header>
                     <div>
...
.main-menu.menu-dark .navigation > li ul .active {
  ...
  .vehicleDetailsection .card.customerInfo{
   ...
   @media only screen and (max-width: 549px) and (min-width: 300px) {
      ...
      #edit-inspection-form-view .nav-pills .nav-link {
      ...
      #description-list-alignment .card.card-transaction{
         margin-bottom: 0px;
      }
      #description-list-alignment .card.card-transaction .card-body{
