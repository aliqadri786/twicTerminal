    ...
    <b-card title="" class="bgTransparent" style="padding: 0px;margin: 0px;">
                    ...
                    <b-row>
                        <b-col cols="12">
                            <div
                                ...
                                style="border-bottom: 0.25px solid rgb(208 204 201) !important;"
                            >
                                <div class="media" style="width: 100%">
                                    <div
                                        class="media-aside mr-75 align-self-start"
                                    ></div>
                                    <div class="media-body my-auto">
                                        <b-form class="" @submit="addNotes">
                                            <b-form-group
                                                label="Description"
                            ...
                            <div
                                class="employee-task d-flex justify-content-between align-items-center mb-1"
                                style="border-bottom: 0.25px solid rgb(208 204 201) !important;"
                                v-for="(notes, key) in InspectionNotes"
                            >
                                <div class="media" style="width: 100%">
                                    <div
                                        class="media-aside mr-75 align-self-start"
                                    ></div>
                                    <div
                                        class="media-body my-auto"
                                        @mouseover="
                                            Inspectionnotesactivation = false
                                        "
                                        @mouseleave="
                                    ...
                                    >
                                        ...
                                        <small
                                            class="text-muted mr-75"
                                            style="float: right;"
                                            >{{
                                                makeCorrectDate(notes.added_on)
                                            }}</small
                                        >
                                    </div>
                                </div>
        ...
        >
            <b-card-code title="Vehicle Details">
                <div>
                    <b-row>
                        <b-col cols="4">
                            <b-form-group label="Length" label-for="vue-select">
                                <b-form-input
                                    id="Length"
                        ...
                        <b-col cols="4">
                            <b-form-group label="Weight" label-for="vin-number">
                                <b-form-input
                                    id="Weight"
                        ...
                        <b-col cols="4">
                            <b-form-group label="Height" label-for="vue-select">
                                <b-form-input
                                    id="Height"
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group label="Color" label-for="vue-select">
                                <b-form-input
                                    id="Color"
        ...
        >
            <b-card-code title="Update Inspection" class="nobordereredtocard">
                <b-tabs pills class="verticalPill">
        ...
        <div class="row innercard">
            <div class="col-md-8 col-lg-8 col-xl-8 col-12 vehicleDetailsection">
                <div class="card border-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div
                                class="d-flex justify-content-between flex-column col-xl-8 col-21"
                            >
                                <div class="d-flex justify-content-start">
                                    <span
                                        class="b-avatar badge-light-info rounded"
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <div class="d-flex align-items-center mr-2">
                                        <span
                                            class="b-avatar badge-light-success rounded"
                                        >
                                            <span class="b-avatar-custom">
                                                <svg
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 col-12 vehicleDetailsection">
                <div
                    ...
                    @mouseover="customereditactiveicon = false"
                        ...
                        <ul class="list-unstyled my-1">
                            <li class="pb-1">
                                <span class="align-middle">
                                    ...
                                    />
                                    <span class="font-weight-bold"
                                        >{{ inspection.customer_first_name }}
                                        {{
                                            inspection.customer_last_name
                                        }}</span
                                    >
                                </span>
                            </li>
        ...
        <div class="row innercard">
            <div class="col-md-8 col-lg-8 col-xl-8 col-12 ">
                ...
                >
                    <b-card-header
                        @mouseover="Inspectionoptionsactivated = false"
                ...
                >
                    <b-card-header>
                        ...
                        <b-sidebar
                            ...
                            #default="{ hide }"
                        >
                            <b-card-code title="Vehicle Details"> </b-card-code>
                        </b-sidebar>

                        <a
                            href="javascript:void()"
                            v-b-toggle.inspection-notes
                            class="view_notes_link"
                        >
                            View Notes</a
                        >
                    </b-card-header>
...
"
                                    >
                                        <!-- <h6 data-v-78eec882="">Invoices paid</h6> -->
                                        <small
                                            data-v-78eec882=""
                                            class="text-muted"
                                            >{{
                                    ...
                                    <!--  <p data-v-78eec882=""><img data-v-78eec882="" src="/images/_/_/_/_/twic_terminal/frontend/src/assets/images/icons/pdf.png" width="20" class="mr-1"> <span data-v-78eec882="" class="align-bottom">invoice.pdf</span></p> -->
                                </li>
                            </app-timeline>
                        </template>
                    </b-card-body>
        ...
        <div class="row innercard">
            <div class="col-md-8 col-lg-8 col-xl-8 col-12 ">
                <b-card class="card-transaction addbordered" no-body>
                    <b-card-header>
                    ...
                    <b-card-body>
                        <div class="demo-inline-spacing mt-2">
                            <img
                                src="https://auto1-homepage.prod.mp.auto1.cloud/static/optimized/blue-car-hp-left-bmw.png"
                                style="width: 100%"
                            />
                        </div>
                    </b-card-body>
      ...
      "
                            ...
                            <div
                                ...
                                style="position: relative;float: right;width: 20%;"
                            >
                                <span
         ...
         "
                                ...
                                <div style="min-height: 32.7px;">
                                    <div
                                        id="apexchartsns778nqcf"
                                        class="apexcharts-canvas apexchartsns778nqcf apexcharts-theme-light"
                                        style="width: 30px; height: 32.7px;"
                                    >
                                        <feather-icon
                                            icon="DeleteIcon"
                                            size="16"
                        ...
                        <div class="mt-1">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    v-model="AddInspectionDocuments.title"
                                >
                                    <option value="">Select</option>
                                    <option value="1">Title Package</option>
                                    <option value="2">Dock Receipt</option>
                                </select>
                            </div>
                            <b-form-file
                                placeholder="Select file to up"
                                v-model="AddInspectionDocuments.file"
...
export default {
    ...
    methods: {
        getinspectiondata: function(vin_number) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/inspection-details-by-vin-number?vin_number=" +
                        vin_number
                )
                .then(response => {
                    ...
                    this.InspectionWorkOrder =
                        response.data.InspectionWorkOrder;
                    this.InspectionActivities =
                        response.data.InspectionActivities;
                    this.InspectionNotes = response.data.InspectionNotes;
                    this.InspectionDocuments =
                        response.data.InspectionDocuments;
        ...
        addNotes(e) {
            ...
            if (this.AddInspectionNotes.description != "") {
                axios({
                    method: "post",
                    url:
                        "http://koboautos.com/twic-terminal/connect/api/create-inspection-notes?vin_number=" +
                        this.inspection.vin_number +
                        "&description=" +
                        this.AddInspectionNotes.description +
                        "&key=" +
        ...
        uploaddocuments() {
            if (this.AddInspectionDocuments.title != "") {
                ...
                reader.onload = () => {
                    ...
                    axios
                        .post(
                            "http://koboautos.com/twic-terminal/connect/api/upload-documents",
                            {
                                document: reader.result,
                                status_list_id: this.AddInspectionDocuments
                                    .title,
        ...
        deletenotes(rowid) {
            if (confirm("Do you really want to delete?")) {
                axios({
                    method: "post",
                    url:
                        "http://koboautos.com/twic-terminal/connect/api/delete-inspection-notes?&key=" +
                        rowid
                })
                    .then(function(response) {
                        console.log(response);
        ...
        deletedocument(rowid) {
            if (confirm("Do you really want to delete?")) {
                axios({
                    method: "post",
                    url:
                        "http://koboautos.com/twic-terminal/connect/api/delete-documents?&key=" +
                        rowid
                })
                    .then(function(response) {
                        console.log(response);
...
.rightDetai.text-info,
.rightDetai.text-success,
.rightDetai.text-primary {
    /*font-size: 13px;*/
    color: #000 !important;
}
...
.card-transaction.vehicleDetailsection,
.card-transaction.customerdetailsection {
    height: 240px !important;
}
...
.timelinedetailsectiom {
    height: 400px !important;
}
.bgTransparent .card-body {
    padding: 0px !important;
}
.innercard .card-body,
.b-sidebar-outer .card-body {
