<template>
  <div>
    ...
    <b-form class="mt-1" @submit="formSubmit33">
      <b-row>
        ...
        viewcustomer: function(rowid) {
         ...
         viewcustomer: function(rowid) {
            axios
                ...
                .then(response => {
                    this.customerinfo = response.data.userinfo;
                    this.customerinfo.terminal.title = response.data.userinfo.terminal;
                    this.customerinfo.country.title = response.data.userinfo.country;
                })
                .catch(error => {
                    console.log(error);
                });
