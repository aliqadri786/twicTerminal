      ...
      >
        ...
        <template #cell(email)="data">
          <div class="text-nowrap">
            ...
            />
            <span class="align-text-top text-capitalize">naeem@friendsitsolutions.com</span>
          </div>
        </template>
        ...
        <template #cell(gender)="data">
            <div class="text-nowrap">
                <span class="align-text-top text-capitalize">male</span>
            </div>
        </template>
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr
                            ...
                            data-pk="50"
                            class=""
                            v-for="(customer, key) in customersinfo"
                        >
                                ...
                                <div class="media">
                                    <div class="media-aside align-self-center">
                                        ...
                                        >
                                            <span
                                                class="b-avatar-text"
                                                style="'font-size: calc(12.8px);color: '+customer.txtcolor +';background:'+ customer.bgcolor+'"
                                            >
                            ...
                            <td aria-colindex="2" role="cell" class="">
                                ...
                                >
                                    {{ customer.user_assigned_terminals }}
                                </span>
                            </td>

                            <td aria-colindex="2" role="cell" class="">
                                <span
                                    class="badge text-capitalize badge-light-danger badge-pill"
                                >Pending
                                </span>
                            </td>
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/all-users-listing?page=" +
                        page,
                    {
                        headers: {
