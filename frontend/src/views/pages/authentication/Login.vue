        ...
        <b-row class="auth-inner m-0">
            ...
            <b-col lg="4" class="d-flex align-items-center auth-bg px-2 p-lg-5">
                <b-col sm="8" md="6" lg="12" class="px-xl-2 mx-auto">
                    <b-card-title class="mb-1 font-weight-bold" title-tag="h4">
...
export default {
    ...
    methods: {
        login() {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/oauth/token",
                    {
                        token_name: "Terminal",
                        client_id: "19384712",
                        client_secret:
                            "iTAxbwQAc7Ar6LR4HPiNalQ1yKzeOeQmy9QwUFtK",
                ...
                .then(response => {
                    ...
                    axios
                        .post(
                            "http://koboautos.com/twic-terminal/connect/api/login",
                            {
