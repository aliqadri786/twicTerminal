<template>
  ...
  <div>
    ...
    <a href="javascript:void();" style="float: right;color: #00cfe8;font-weight: bold;"  v-on:click="isHidden = !isHidden" >Advance Search</a>
        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              >
                <span class="text-nowrap">Create Inventory</span>
              </b-button>
   ...
   <table role="table" aria-busy="false" aria-colcount="9" class="table b-table" id="__BVID__173">
      <!----><!---->
      ...
      <tbody role="rowgroup">
         <!---->
         <tr role="row" id="__BVID__173__row_76" data-pk="76" class=""  v-for="inventory, key in inventorylist.data">
            ...
            <td aria-colindex="2" role="cell" class="">
               <div class="text-nowrap">
                  <p><router-link :to="'/inventory/view/'+inventory.vin_number">{{ inventory.vin_number }}</router-link></p>
               </div>
            </td>
            <td aria-colindex="3" role="cell" class="">
               <div class="text-nowrap">
                  <p>{{ inventory.year }} {{ inventory.make }} {{ inventory.model }}</p>
               </div>
            </td>
            <td aria-colindex="4" role="cell" class="">
               <div class="text-nowrap">
                  <p v-if="inventory.customerinfo !== null">{{ inventory.customerinfo.first_name }} {{ inventory.customerinfo.last_name }}</p>
               </div>
            </td>
            <td aria-colindex="5" role="cell" class="">
               <div class="text-nowrap">
                   <p v-if="inventory.terminalinfo !== null">{{ inventory.terminalinfo.title }} </p>
               </div>
            </td>
            <td aria-colindex="6" role="cell" class="">
               <div class="text-nowrap">
                  <p class="align-text-top text-capitalize">{{ inventoryduration[++key - 2] }}</p>
               </div>
            </td>
            <td aria-colindex="7" role="cell" class="">
               <div class="text-nowrap">
                  <p class="align-text-top text-capitalize">$ {{ inventory.amount_remaining }}</p>
               </div>
            </td>
            <td aria-colindex="8" role="cell" class=""><span class="badge text-capitalize badge-light-primary badge-pill">
               {{ inventory.status }}
               </span>
            </td>
            <td aria-colindex="9" role="cell" class="">
               <div class="dropdown b-dropdown btn-group" id="__BVID__235">
                  <!---->
                  <button aria-haspopup="true" aria-expanded="false" type="button" class="btn dropdown-toggle btn-link dropdown-toggle-no-caret" id="__BVID__235__BV_toggle_">
                  ...
                  <ul role="menu" tabindex="-1" class="dropdown-menu" aria-labelledby="__BVID__235__BV_toggle_">
                     <li role="presentation">
                        <a href="/apps/users/view/76" class="dropdown-item" role="menuitem" target="_self">
                     ...
                     <li role="presentation">
                        <a href="/apps/users/edit/76" class="dropdown-item" role="menuitem" target="_self">
      ...
      <div class="mx-2 mb-2">
        <b-row>
          ...
          >
            <span class="text-muted">Showing {{ inventorylist.from }} to {{ inventorylist.to }} of {{ inventorylist.of }} entries</span>
          </b-col>
          <!-- Pagination -->
          <b-col
            cols="12"
