        ...
        <b-card no-body class="mb-0">
            ...
            <form @submit="formSubmit">
                <div class="m-2">
                    ...
                    <b-row class="mb-2">
                        <b-col cols="12" md="4">
                            <label for="basicInput" class="d-block">CC</label>
                            <div
                                class="d-flex align-items-center justify-content-end"
                            >
                                <b-form-input
                                    name="cc"
                                    class="d-inline-block mr-1"
                                    v-model="formfields.cc"
                                />
                            </div>
                        </b-col>

                        <b-col cols="12" md="4">
                            <label for="basicInput" class="d-block">BCC</label>
                            <div
                                class="d-flex align-items-center justify-content-end"
                            >
                                <b-form-input
    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            axios({
                method: "post",
                url:
                    "http://koboautos.com/twic-terminal/connect/api/update-email-template?key=" +
                    rowid,
        ...
        getempdata: function(rowid) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/view-email-template?key=" +
                        rowid
                )
                .then(response => {
