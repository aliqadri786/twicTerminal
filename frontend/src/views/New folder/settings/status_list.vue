<template>
    <div>
        <b-card no-body class="mb-0">
            ...
            <div class="position-relative table-responsive">
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr v-for="(StatusList, index) in StatusList.data">
                            <td>{{ ++index }}</td>
                            <td>
                                {{ StatusList.title }}
                            </td>
                            <td>
                                <p v-if="StatusList.group_id !== null">
                                    {{ StatusList.groupinfo.name }}
                                </p>
                            </td>
                            <td>
                                <!-- <a
                                    href="javascript:;"
                                    v-on:click="deleteStatusList(StatusList.id)"
                                > 
                                    <feather-icon
                                        icon="DeleteIcon"
                                        size="16"
                        ...
                        <!-- <tr>
         <td>2</td>
         <td><router-link  :to="'/create-status-list'">Stamped Dock Receipts</router-link></td>
       ...
       <tr>
         <td>3</td>
         <td><router-link  :to="'/create-status-list'">Open</router-link></td>
         <td>Work Orders</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
       ...
       <tr>
         <td>4</td>
         <td><router-link  :to="'/create-status-list'">In Process</router-link></td>
         <td>Work Orders</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
       ...
       <tr>
         <td>5</td>
         <td><router-link  :to="'/create-status-list'">Exception</router-link></td>
         <td>Work Orders</td>
         <td>
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ StatusList.from }} to
                            {{ StatusList.to }} of
                            {{ StatusList.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/StatusList?page=" +
                        page,
                    {
                        headers: {
        ...
        deleteStatusList: function(rowid) {
