<template>
    <div>
        <b-card no-body class="mb-0">
                    ...
                    <b-col cols="12" md="6">
                        ...
                        >
                            ...
                            <router-link
                                ...
                                >Create Inspection List</router-link
                            >
                        </div>
                    </b-col>
                </b-row>
            ...
            <div class="position-relative table-responsive">
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr
                            v-for="(inspection,
                            index) in inspectionCategories.data"
                        >
                            <td>{{ ++index }}</td>
                            <td>
         ...
         <td>2</td>
         <td>Front</td>
         <td><router-link  :to="'/create-categories'">Hood</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr> -->
                        <!-- <td>3</td>
         <td>Front</td>
         <td><router-link  :to="'/create-categories'">Bumper</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
         ...
         <td>4</td>
         <td>Passenger</td>
         <td><router-link  :to="'/create-categories'">Front Fender</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
         ...
         <td>5</td>
          <td>Passenger</td>
         <td><router-link  :to="'/create-categories'">Mirror</router-link></td>
         <td>
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ inspectionCategories.from }} to
                            {{ inspectionCategories.to }} of
                            {{ inspectionCategories.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
                    ...
                    >
                        <b-pagination
                            v-model="currentPage"
                            :total-rows="inspectionCategories.total"
                            :per-page="perPage"
                            first-text="First"
                            prev-text="Prev"
                            next-text="Next"
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    " http://koboautos.com/twic-terminal/connect/api/inspectionCategories?page=" +
                        page,
                    {
                        headers: {
                ...
                .then(response => {
                    ...
                    this.inspectionCategories =
                        response.data.inspectionCategories;
