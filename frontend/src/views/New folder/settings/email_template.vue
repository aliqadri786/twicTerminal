        ...
        <b-card no-body class="mb-0">
                    ...
                    <b-col cols="12" md="6">
                        ...
                        >
                            ...
                            <router-link
                                ...
                                >Create Email Template</router-link
                            >
                        </div>
                    </b-col>
                </b-row>
            ...
            <div class="position-relative table-responsive">
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr
                            v-for="(EmailTemplate, index) in EmailTemplate.data"
                        >
                            <td>{{ ++index }}</td>
                            <td>{{ EmailTemplate.title }}</td>
                            <td>{{ EmailTemplate.from_name }}</td>
                        ...
                        <!-- <tr>
         <td>2</td>
         <td><router-link  :to="'/create-email-template'">Need Confirmation</router-link></td>
         <td>SPS Jacksonville</td>
         <td>Need Confirmation on Work Orders</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ EmailTemplate.from }} to
                            {{ EmailTemplate.to }} of
                            {{ EmailTemplate.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
                    ...
                    >
                        <b-pagination
                            v-model="currentPage"
                            :total-rows="EmailTemplate.total"
                            :per-page="perPage"
                            first-text="First"
                            prev-text="Prev"
                            next-text="Next"
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/EmailTemplate?page=" +
                        page,
                    {
                        headers: {
        ...
        deleteEmailTemplate: function(rowid) {
            alert();
            axios
                .post(
