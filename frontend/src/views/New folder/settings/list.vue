<template>
    <div>
        <b-card no-body class="mb-0">
            ...
            <div class="position-relative table-responsive">
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr v-for="(inspection, index) in inspectiontypes.data">
                            <td>{{ ++index }}</td>
                            <td>
                                <router-link
                                    :to="'/inspection/update/' + inspection.id"
                        ...
                        <!-- <tr>
         <td>2</td>
         <td><router-link  :to="'/create-inspection-types'">Front</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>3</td>
         <td><router-link  :to="'/create-inspection-types'">Passenger</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>4</td>
         <td><router-link  :to="'/create-inspection-types'">Rear</router-link></td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>5</td>
         <td><router-link  :to="'/create-inspection-types'">Driver</router-link></td>
         <td>
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ inspectiontypes.from }} to
                            {{ inspectiontypes.to }} of
                            {{ inspectiontypes.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
                    ...
                    >
                        <b-pagination
                            v-model="currentPage"
                            :total-rows="inspectiontypes.total"
                            :per-page="perPage"
                            first-text="First"
                            prev-text="Prev"
                            next-text="Next"
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/inspectiontypes?page=" +
                        page,
                    {
                        headers: {
                ...
                .then(response => {
                    ...
                    this.inspectiontypes = response.data.inspectiontypes;
