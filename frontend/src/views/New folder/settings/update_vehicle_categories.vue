    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            axios({
                method: "post",
                url:
                    "http://koboautos.com/twic-terminal/connect/api/update-vehicle-categories?key=" +
                    rowid +
                    "&title=" +
                    this.formfields.title +
                    "&basis=" +
                    this.formfields.basis.value +
                    "&part=" +
                    this.formfields.part.value +
                    "&unit=" +
                    this.formfields.unit.value +
                    "&operator=" +
                    this.formfields.operator.value +
                    "&value=" +
                    this.formfields.value +
                    "&condition=" +
                    this.formfields.condition.value
