<template>
    <div>
        <b-card no-body class="mb-0">
                    ...
                    <b-col cols="12" md="6">
                        ...
                        >
                            ...
                            <router-link
                                ...
                                :to="'/create-status-group'"
                                >Create Status Group</router-link
                            >
                        </div>
                    </b-col>
                </b-row>
            ...
            <div class="position-relative table-responsive">
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr v-for="(inspection, index) in statusGroup.data">
                            <td>{{ ++index }}</td>
                            <td>
                                {{ inspection.name }}
                            </td>
                        ...
                        <!-- <tr>
         <td>2</td>
         <td><router-link  :to="'/create-status-group'">Cost Type</router-link></td>
         <td>Types of cost variables used at Terminal pricing</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>3</td>
         <td><router-link  :to="'/create-status-group'">Payment Mode</router-link></td>
         <td>Payment mode used for inventory</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>4</td>
         <td><router-link  :to="'/create-status-group'">Inventory Status</router-link></td>
         <td>Statuses that govern inventory items</td>
         <td>
          <feather-icon
            icon="DeleteIcon"
            size="16"
       ...
       <tr>
         <td>5</td>
         <td><router-link  :to="'/create-status-group'">Customer Type</router-link></td>
         <td>Account type for customers of TWIC Services</td>
         <td>
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ statusGroup.from }} to
                            {{ statusGroup.to }} of
                            {{ statusGroup.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/statusGroup?page=" +
                        page,
                    {
                        headers: {
        ...
        deleteSettings: function(rowid) {
            ...
            axios
                ...
                .then(response => {
                    this.statusGroup = this.statusGroup.filter(
                        statusGroup => statusGroup.id != rowid
                    );
