                    ...
                    <b-col cols="12" md="6">
                        ...
                        >
                            ...
                            <router-link
                                ...
                                :to="'/create-vehicle-categories'"
                                >Create Vehicle Category</router-link
                            >
                        </div>
                    </b-col>
                </b-row>
                ...
                >
                    ...
                    <tbody role="rowgroup">
                        <tr
                            ...
                            class="odd"
                            v-for="(inspection,
                            index) in VehicleCategories.data"
                        >
                            <td class="sorting_1">{{ ++index }}</td>
                            <td>
                                {{ inspection.title }}
                            </td>
                            <td>{{ inspection.basis }}</td>
                ...
                <b-row>
                    ...
                    >
                        <span class="text-muted"
                            >Showing {{ VehicleCategories.from }} to
                            {{ VehicleCategories.to }} of
                            {{ VehicleCategories.of }} entries</span
                        >
                    </b-col>
                    <!-- Pagination -->
                    <b-col
                    ...
                    >
                        <b-pagination
                            v-model="currentPage"
                            :total-rows="VehicleCategories.total"
                            :per-page="perPage"
                            first-text="First"
                            prev-text="Prev"
                            next-text="Next"
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios
                .post(
                    "http://koboautos.com/twic-terminal/connect/api/VehicleCategories?page=" +
                        page,
                    {
                        headers: {
