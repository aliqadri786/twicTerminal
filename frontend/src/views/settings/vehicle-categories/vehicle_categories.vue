    ...
    >
      ...
      >
        ...
        <template #cell(category)="data">
              <div class="text-nowrap">Small Sedans</div>
        </template>

        <template #cell(basis)="data">
          <div class="text-nowrap">Dimensions</div>
        </template>

        <template #cell(part)="data">
          <div class="text-nowrap">Width</div>
        </template>

        <template #cell(unit)="data">
          <div class="text-nowrap">Pounds</div>
        </template>
        ...
        <template #cell(value)="data">
          <div class="text-nowrap">1212.12</div>
        </template>

        <template #cell(and_or)="data">
          <div class="text-nowrap">AND</div>
        </template>
