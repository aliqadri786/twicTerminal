                                ...
                                >
                                    <b-form-group>
                                        <textarea
                                            ...
                                            class="form-control"
                                            data-v-aa799a9e=""
                                            v-model="statusGroup.description"
                                            :state="
                                                getValidationState(
                                                    validationContext
                                                )
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const statusGroup = ref(JSON.parse(JSON.stringify(blankstatusGroup)));
        const resetstatusGroup = () => {
            statusGroup.value = JSON.parse(JSON.stringify(blankstatusGroup));
        };

        const onSubmit = () => {
            store.dispatch("app-user/addUser", statusGroup.value);
        };
        ...
        const {
            ...
            getValidationState,
            resetForm
        } = formValidation(resetstatusGroup);
            ...
            axios
                ...
                .then(function(response) {
                    ...
                    if (response.status == 200) {
                        currentObj.$router.push({ path: "/status-group" });
                    }
                })
                .catch(error => {
                    console.log(error);
